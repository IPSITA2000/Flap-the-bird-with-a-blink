...
class FlappyBird:
    def __init__(self):
        self.screen = pygame.display.set_mode((550, 600)) #pygame window size
        self.bird = pygame.Rect(100, 200, 100, 200)
        self.background = pygame.image.load("background-day.png").convert()
        self.birdSprites = [pygame.image.load("bluebird-upflap.png").convert_alpha(),
            pygame.image.load("bluebird-midflap.png").convert_alpha(),
            pygame.image.load("bluebird-downflap.png")]
        self.wallUp = pygame.image.load("pipe-green.png").convert_alpha()
        self.wallDown = pygame.image.load("pipe-green.png").convert_alpha()
        self.gap = 200
        self.wallx = 200
        self.birdY = 150
        self.jump = 0
